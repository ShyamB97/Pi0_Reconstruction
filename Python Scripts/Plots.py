...
def PlotHist(data, bins=100, xlabel="", title="", label="", alpha=1, sf=2, density=False):
    """
...
def PlotHistComparison(data_1, data_2, bins=100, xlabel="", title="", label_1="", label_2="", alpha=1, sf=2, density=False):
    """
